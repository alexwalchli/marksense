...
/***/ function(module, exports, __webpack_require__) {
	...
	var _acorn = __webpack_require__(3);
	  ...
	  _createClass(MarkSense, [{
	    ...
	    value: function generateSnippetTree(code) {
	      ...
	      Object.keys(snippetTree).forEach(function (key) {
	        var node = snippetTree[key];
	        var childrenCount = node.children.reduce(function (acc, curr) {
	    ...
	    key: 'newRootSnippet',
	    value: function newRootSnippet(rootKey) {
	    ...
	    key: 'getDeeperSnippet',
	    value: function getDeeperSnippet() {
	      var currentSnippet = this.snippetTree[this.currentKey];
	      var nextSnippet = currentSnippet.children[0];
	    ...
	    key: 'getShallowerSnippet',
	    value: function getShallowerSnippet() {
	    ...
	    key: 'getSnippetAbove',
	    value: function getSnippetAbove() {
	      var parent = this.snippetTree[this.currentKey].parent;
